...
import 'package:app_doa/doa/DoaPage.dart';
import 'package:app_doa/tema.dart';
import 'package:open_file/open_file.dart';
import 'package:pdf/pdf.dart';
import 'package:path_provider/path_provider.dart';

class DetailDataDoa extends StatefulWidget {
  final List list;
  final int index;
  DetailDataDoa({required this.list, required this.index});

  @override
  _DetailDataDoaState createState() => _DetailDataDoaState();
}

class _DetailDataDoaState extends State<DetailDataDoa> {
        ...
        actions: [
          TextButton(
            onPressed: () =>
              ...
              builder: (BuildContext context) => new DoaPage(),
            )),
            child: Text(
              "Back",
              style: oswaldTextStyle.copyWith(
