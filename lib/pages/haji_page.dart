...
class HajiPage extends StatefulWidget {
  const HajiPage({super.key});
  final String title = "DOA DARI ALQUR'AN";
  @override
  HajiPageState createState() => HajiPageState();
}

class HajiPageState extends State<HajiPage> {
  TextEditingController searchController = TextEditingController();
  String search = '';

  Future<List<Doa>> ReadJsonData() async {
    final jsondata =
        await rootBundle.rootBundle.loadString('assets/data/haji.json');
